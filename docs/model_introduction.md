...
> <a href="https://www.codecogs.com/eqnedit.php?latex=p(x|z)&space;=&space;N(x|\mu&space;_{x},&space;\sigma_{x}^{2}I)" target="_blank"><img src="https://latex.codecogs.com/gif.latex?p(x|z)&space;=&space;N(x|\mu&space;_{x},&space;\sigma_{x}^{2}I)" title="p(x|z) = N(x|\mu _{x}, \sigma_{x}^{2}I)" /></a>    
